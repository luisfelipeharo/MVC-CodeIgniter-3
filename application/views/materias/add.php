<?php echo form_open('materia/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="idProfesor" class="form-control">
				...
				{
					$selected = ($profesor['idProfesor'] == $this->input->post('idProfesor')) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="nombreMateria" value="<?php echo $this->input->post('nombreMateria'); ?>" class="form-control" id="nombreMateria" />
		</div>
	</div>
	<div class="form-group">
		<label for="diaMateria" class="col-md-4 control-label">DiaMateria</label>
		<div class="col-md-8">
			<input type="text" name="diaMateria" value="<?php echo $this->input->post('diaMateria'); ?>" class="form-control" id="diaMateria" />
		</div>
	</div>
	<div class="form-group">
		<label for="horaInicio" class="col-md-4 control-label">HoraInicio</label>
		<div class="col-md-8">
			<input type="text" name="horaInicio" value="<?php echo $this->input->post('horaInicio'); ?>" class="form-control" id="horaInicio" />
		</div>
	</div>
	<div class="form-group">
		<label for="horaFin" class="col-md-4 control-label">HoraFin</label>
		<div class="col-md-8">
			<input type="text" name="horaFin" value="<?php echo $this->input->post('horaFin'); ?>" class="form-control" id="horaFin" />
		</div>
	</div>
